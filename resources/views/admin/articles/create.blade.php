...
@section('title', 'Nouvel Article — Admin BFF')
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" required
                        ...
                        placeholder="Ex: Comment développer son mental de champion">
                </div>
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-1">Laisse vide pour générer automatiquement</p>
                </div>
                ...
                {{-- Résumé --}}
                <div class="md:col-span-2">
                    <label class="block text-sm font-semibold text-slate-300 mb-2">Résumé / Excerpt</label>
                    <textarea name="excerpt" rows="2"
                        class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-amber-500 transition resize-none"
                        placeholder="Courte description affichée dans les listes (max 500 caractères)">{{ old('excerpt') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="file" name="cover_image" accept="image/*"
                        class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl text-slate-400 focus:outline-none file:mr-3 file:py-1 file:px-3 file:rounded-full file:border-0 file:text-xs file:bg-amber-500/20 file:text-amber-400 cursor-pointer">
                </div>

                {{-- Temps de lecture --}}
                <div>
                    <label class="block text-sm font-semibold text-slate-300 mb-2">Temps de lecture (minutes)</label>
                    <input type="number" name="reading_time" value="{{ old('reading_time', 5) }}" min="1" max="120"
                        class="w-full px-4 py-3 bg-slate-800/50 border border-slate-700 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-amber-500 transition">
                </div>
                ...
                <div class="md:col-span-2">
                    <label class="flex items-center gap-3 cursor-pointer">
                        ...
                        <div>
                            <span class="text-sm font-semibold text-slate-200">Publier immédiatement</span>
                            <p class="text-xs text-slate-500">Si non coché, l'article sera enregistré comme brouillon</p>
                        </div>
                    </label>
                </div>
            </div>
